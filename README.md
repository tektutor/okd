...
##### We need to create a file named /var/named/okd.org.db with the below content

<pre>
$TTL 86400
@ IN SOA tektutor.okd.org. admin.okd.org. (
                                                2020011800 ;Serial
                                                3600 ;Refresh
                                                1800 ;Retry
                                                604800 ;Expire
...
@ IN NS tektutor.okd.org.

;IP Address for Name Server
tektutor IN A 192.168.167.140

;Mail Server MX (Mail exchanger) Record
okd.org. IN MX 10 mail.okd.org.

;A Record for the following Host name
www  IN   A   192.168.167.140
mail IN   A   192.168.167.140

;CNAME Record
ftp  IN   CNAME www.okd.org.
</pre>

##### Similarly, we need to create another file named /var/named/okd.org.rev with the below content

<pre>
$TTL 86400
@ IN SOA tektutor.okd.org. admin.tektutor.org. (
                                            2020011800 ;Serial
                                            3600 ;Refresh
                                            1800 ;Retry
                                            604800 ;Expire
...
140 IN PTR tektutor.okd.org.

;PTR Record IP address to Hostname
50      IN      PTR     www.okd.org.
60      IN      PTR     mail.okd.org.                                     
</pre>

##### Make sure the file owner is updated to named:named user as shown below

```
chown named:named /var/named/okd.org.db
chown named:named /var/named/okd.org.rev
```

###### We need to add the below line in /etc/resolv.conf

<pre>
search localdomain okd.org
<b>nameserver 192.168.167.140</b>
</pre>
...
The expected output is
<pre>
[root@tektutor ~]# nslookup tektutor.okd.org
Server:		192.168.167.140
Address:	192.168.167.140#53

Name:	tektutor.okd.org
Address: 192.168.167.140
</pre>

You may also try
```
nslookup mail.okd.org
```
The expected output is
<pre>
[root@tektutor ~]# <b>nslookup mail.okd.org</b>
Server:		192.168.167.140
Address:	192.168.167.140#53
...
You may also try
```
nslookup www.okd.org
```
The expected output is
<pre>
[root@tektutor ~]# <b>nslookup www.okd.org</b>
Server:		192.168.167.140
Address:	192.168.167.140#53
...
You may also try
```
nslookup ftp.okd.org
```
The expected output is
<pre>
[root@tektutor ~]# <b>nslookup ftp.okd.org</b>
Server:		192.168.167.140
Address:	192.168.167.140#53

ftp.okd.org	canonical name = www.okd.org.
Name:	www.okd.org
Address: 192.168.167.140
</pre>
